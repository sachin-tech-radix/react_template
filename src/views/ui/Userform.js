...
import thanks from '../../assets/images/bg/success.png';
import errorImage from '../../assets/images/bg/error.png';
import whatsapp from '../../assets/images/bg/whatsapp.png';
import './navbar.css';
...
const Forms = () => {
  ...
  let [checkboxType, setCheckboxType] = useState({appointment:false,stone:true});
    ...
    const options = {
      ...
      handler: function (response) {
        ...
        let user = {
          ...
          consultancy:checkboxType.appointment
        };
        let url = `${apiPath}user/insertuser`;
        axios.post(url, user, config).then((res) => {
          setErr(res.data.message);
  ...
  return (
    <Row>
      <Col>
            ...
            <CardBody>
                ...
                {formStatus === 3?
                  <div>
                    ...
                    <Row>
                      <Col className='d-flex justify-content-center'>
                      <span style={{ fontWeight: '600', fontSize: '18px',textAlign: 'center',color: 'red'}} className='mt-5' >
                      <br></br>{err}<br></br> </span>
                      </Col>
                    </Row>
                  </div>
                :
                  ...
                  <Row>
                    <Col className='d-flex justify-content-center'>
                      <span style={{ fontWeight: '600', fontSize: '18px',textAlign: 'center'}} className='mt-5' >
                      Thank You For Believing In US.<br></br>
                      Highly Appreciated<br></br> </span>
                  ...
                  <Row>
                    <Col  className='d-flex justify-content-center'>
                    <span style={{ fontWeight: '600', fontSize: '20px',textAlign: 'center',color:'#FF8D06'}} className='mt-1' >
                      Kindly Check Your <img atlt='whatsapp' src={whatsapp}></img> <span className='text-dark'>whatsapp</span><br></br>
                    For Further Suggestions.</span>
                    </Col>
                  </Row>
                ...
                <>
                  <CardBody>
                    <Form >
                      <Row>
                        <Col className='d-flex justify-content-center'>
                          <img src={require("../../assets/images/logos/logp_12.png")} width="210px" height="210px"></img>
                        </Col>
                      </Row>
                      <Row>
                        <Col className='d-flex justify-content-center'>
                          <span style={{ fontWeight: '600', fontSize: '20px' }}>Welcome To Cosmos Vedic World</span>
                        </Col>
                      </Row>
                      <Row className='d-flex justify-content-center'>
                        <Col >
                          <div style={{ fontWeight: '400', fontSize: '19px',textAlign:'center', backgroundColor:'#FF8D06', borderRadius:'30px',padding:'6px',color:'white' }}>Astrology</div>
                          </Col>
                          <Col >
                          <div style={{ fontWeight: '400', fontSize: '19px',textAlign:'center', backgroundColor:'#FF8D06', borderRadius:'30px',padding:'6px',color:'white'  }}>Vastu</div>
                          </Col>
                          <Col >
                          <div style={{ fontWeight: '400', fontSize: '19px',textAlign:'center', backgroundColor:'#FF8D06', borderRadius:'30px' ,padding:'6px',color:'white' }}>Guidance</div>
                        </Col>
                      </Row>
                      <Row className='mt-5'>
                        <Col className='d-flex flex-row justify-content-center'>
                          <FormGroup check>
                            <Input type="checkbox"  defaultChecked name='appointment' /> <Label check className='fw-bolder'>Know Your Lucky Gems@99 Only</Label>
                      ...
                      <Row className=''>
                        <Col className='d-flex flex-row justify-content-center'>
                          <FormGroup check>
                            <Input type="checkbox" name='stone' onClick={(e)=>{setCheckboxType({...checkboxType,appointment:e.target.checked})}} /> <Label check className='fw-bolder'>Shedule Appointment</Label>
                      ...
                      <Row className='mt-5'>
                        <Col className='d-flex flex-row justify-content-center mt-3'>
                          <Button size="lg" style={{ backgroundColor: "#000", borderRadius: '30px', width: '350px' }} onClick={handleNext}> Next <IoArrowForwardSharp></IoArrowForwardSharp></Button>
                        </Col>
                      </Row>
                    </Form>
                    ...
                    <Form onSubmit={payment}>
                      ...
                      <FormGroup>
                        ...
                        <div className="input-group input-group">
                          ...
                          <span className="input-group-text" id="basic-addon1" style={{borderTopRightRadius: '20px', borderBottomRightRadius: '20px'}}><BiRupee /></span>
                      ...
                      {loading ?
                        ...
                        <div className="flex justify-content-center" >
                          ...
                          <Button type="submit" size='lg'   style={{ backgroundColor: "#000", borderRadius: '30px' }} > Confirm Payment @99 Only </Button> 
                          </div>
                      }
                    </Form>
                  </CardBody>
        ...
        <Row>
          <Col className='d-flex justify-content-center ' style={{fontSize:'13px',fontWeight:'900',textAlign:'center'}}>
            105, Rituraj Business Center, <br></br>Bypass Bicholi Mardana, Indore -452016
          </Col>
        </Row>
        <Row>
          <Col className='d-flex justify-content-center'>
            <div style={{backgroundColor:'#ff8d06',borderRadius:'50%',width:'25px',height:'25px',textAlign:'center'}}><ImMobile className='text-white fs-6 '></ImMobile></div>
            <span className='text-dark ml-1 mr-1 mt-2' style={{fontSize:'12px',fontWeight:'900'}}>+91 89 89 88 89 90</span>
            <br></br><div className='mr-1' style={{backgroundColor:'#ff8d06',borderRadius:'50%',width:'25px',height:'25px',textAlign:'center'}}><FaFacebookF className='text-white fs-6 '></FaFacebookF></div>
            <div className='ml-1' style={{backgroundColor:'#ff8d06',borderRadius:'50%',width:'25px',height:'25px',textAlign:'center'}}><BsInstagram className='text-white fs-6 '></BsInstagram></div>
            <span className='text-dark ml-2 mt-2' style={{fontSize:'12px',fontWeight:'900'}}>cosmosvedicworld</span>
          </Col>
        </Row>
      </Col>
    </Row>
